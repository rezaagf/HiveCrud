...
class _HiveDBPageState extends State<HiveDBPage> {
  ...
  final conNim = TextEditingController();
  ...
  Future<void> addUser(String uId, String uName, String uNim) async {
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: FlatButton(
                          onPressed: () =>
                              addUser(conId.text, conName.text, conNim.text),
                          child: Text("Add"),
      ...
      return ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Card(
              ...
              child: ExpansionTile(
                title: Text(
                  "${user[index].user_id} (${user[index].nim})",
                  maxLines: 2,
